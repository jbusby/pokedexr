...
class AbilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ability" do
    assert_difference('Ability.count') do
      post abilities_url, params: { ability: { generation_id: @ability.generation_id, identifier: @ability.identifier } }
    end
  ...
  test "should update ability" do
    patch ability_url(@ability), params: { ability: { generation_id: @ability.generation_id, identifier: @ability.identifier } }
